...
+-----------------------------------------+----------------------------------------------------+-----------------------------+------------------------------------------------------------------------------+
| Config File                             | Environment Variables                              | Default Value               | Description                                                                  |
+=========================================+====================================================+=============================+==============================================================================+
| logs                                    | ``PUFFER_LOGS``                                    | ``"logs"``                  | Path of the directory in which to place the ``pufferpanel.log`` file.        |
+-----------------------------------------+----------------------------------------------------+-----------------------------+------------------------------------------------------------------------------+
| web.host                                | ``PUFFER_WEB_HOST``                                | ``"0.0.0.0:8080"``          | The IP (and port) that the HTTP server listens on.                           |
+-----------------------------------------+----------------------------------------------------+-----------------------------+------------------------------------------------------------------------------+
| panel.enable                            | ``PUFFER_PANEL_ENABLE``                            | ``true``                    | Whether the panel (frontend) is enabled or not.                              |
+-----------------------------------------+----------------------------------------------------+-----------------------------+------------------------------------------------------------------------------+
| panel.database.dialect                  | ``PUFFER_PANEL_DATABASE_DIALECT``                  | ``"sqlite3"``               | | The type of database that the panel is using/connecting to.                |
...
+-----------------------------------------+----------------------------------------------------+-----------------------------+------------------------------------------------------------------------------+
| panel.database.log                      | ``PUFFER_PANEL_DATABASE_LOG``                      | ``false``                   | Whether to enable extra verbose database logging.                            |
+-----------------------------------------+----------------------------------------------------+-----------------------------+------------------------------------------------------------------------------+
| panel.web.files                         | ``PUFFER_PANEL_WEB_FILES``                         | ``"www"``                   | | Path of a directory containing additional/replacement files to serve.      |
|                                         |                                                    |                             | | e.g. additional themes, branding                                           |
+-----------------------------------------+----------------------------------------------------+-----------------------------+------------------------------------------------------------------------------+
| panel.web.cookies.secure                | ``PUFFER_PANEL_WEB_COOKIES_SECURE``                | ``false``                   | Value of the ``Secure`` header for setting cookies                           |
|                                         |                                                    |                             | (see `MDN Set-Header#Secure`_)                                               |
+-----------------------------------------+----------------------------------------------------+-----------------------------+------------------------------------------------------------------------------+
| panel.web.cookies.httpOnly              | ``PUFFER_PANEL_WEB_COOKIES_HTTPONLY``              | ``true``                    | Value of the ``HttpOnly`` header for setting cookies                         |
...
+-----------------------------------------+----------------------------------------------------+-----------------------------+------------------------------------------------------------------------------+
| panel.web.cookies.age                   | ``PUFFER_PANEL_WEB_COOKIES_AGE``                   | ``86400*30``                | Value of the ``Max-Age`` header for setting cookies                          |
|                                         |                                                    |                             | (see `MDN Set-Header#max-agenumber`_)                                        |
+-----------------------------------------+----------------------------------------------------+-----------------------------+------------------------------------------------------------------------------+
| panel.web.cookies.sameSite              | ``PUFFER_PANEL_WEB_COOKIES_SAMESITE``              | ``"Strict"``                | Value of the ``SameSite`` header for setting cookies                         |
...
+-----------------------------------------+----------------------------------------------------+-----------------------------+------------------------------------------------------------------------------+
| panel.settings.companyName              | ``PUFFER_PANEL_SETTINGS_COMPANYNAME``              | ``"PufferPanel"``           | Name that is displayed in the user interface (e.g. heading).                 |
+-----------------------------------------+----------------------------------------------------+-----------------------------+------------------------------------------------------------------------------+
| panel.settings.defaultTheme             | ``PUFFER_PANEL_SETTINGS_DEFAULTTHEME``             | ``"PufferPanel"``           | | The theme that is selected by default, if not overridden by a user.        |
...
+-----------------------------------------+----------------------------------------------------+-----------------------------+------------------------------------------------------------------------------+
| panel.settings.masterUrl                | ``PUFFER_PANEL_SETTINGS_MASTERURL``                | ``"http://localhost:8080"`` | The base URL that the panel can be reached.                                  |
+-----------------------------------------+----------------------------------------------------+-----------------------------+------------------------------------------------------------------------------+
...
+-----------------------------------------+----------------------------------------------------+-----------------------------+------------------------------------------------------------------------------+
| panel.registrationEnabled               | ``PUFFER_PANEL_REGISTRATIONENABLED``               | ``true``                    | Whether users should be able to register accounts themselves.                |
+-----------------------------------------+----------------------------------------------------+-----------------------------+------------------------------------------------------------------------------+
| panel.token                             | ``PUFFER_PANEL_TOKEN``                             | ``""``                      | | The seed used to generate the private key for singing JWTs.                |
|                                         |                                                    |                             | | If this value is empty, a new value is generated and saved in the config.  |
+-----------------------------------------+----------------------------------------------------+-----------------------------+------------------------------------------------------------------------------+
| daemon.enable                           | ``PUFFER_DAEMON_ENABLE``                           | ``true``                    | Whether the daemon (backend) is enabled.                                     |
+-----------------------------------------+----------------------------------------------------+-----------------------------+------------------------------------------------------------------------------+
| daemon.console.buffer                   | ``PUFFER_DAEMON_CONSOLE_BUFFER``                   | ``50``                      | Size of the memory buffer used to cache a server's output in KB.             |
+-----------------------------------------+----------------------------------------------------+-----------------------------+------------------------------------------------------------------------------+
| daemon.console.forward                  | ``PUFFER_DAEMON_CONSOLE_FORWARD``                  | ``false``                   | Whether to forward the output of servers to stdout.                          |
+-----------------------------------------+----------------------------------------------------+-----------------------------+------------------------------------------------------------------------------+
| daemon.sftp.host                        | ``PUFFER_DAEMON_SFTP_HOST``                        | ``"0.0.0.0:5657"``          | The IP (and port) that the SFTP server listens on.                           |
+-----------------------------------------+----------------------------------------------------+-----------------------------+------------------------------------------------------------------------------+
| daemon.sftp.key                         | ``PUFFER_DAEMON_SFTP_KEY``                         | ``"sftp.key"``              | | The path to a file containing the private key used by the SFTP server.     |
|                                         |                                                    |                             | | If this file does not exist, it is generated with a fresh private key.     |
+-----------------------------------------+----------------------------------------------------+-----------------------------+------------------------------------------------------------------------------+
| daemon.sftp.log                         | ``PUFFER_DAEMON_SFTP_LOG``                         | ``false``                   | Whether to enable debug logging for the SFTP server.                         |
+-----------------------------------------+----------------------------------------------------+-----------------------------+------------------------------------------------------------------------------+
| daemon.auth.url                         | ``PUFFER_DAEMON_AUTH_URL``                         | ``"http://localhost:8080"`` | The url of the panel to authenticate to.                                     |
|                                         |                                                    |                             |                                                                              |
...
|                                         |                                                    |                             | when registering the remote node.                                            |
+-----------------------------------------+----------------------------------------------------+-----------------------------+------------------------------------------------------------------------------+
| daemon.data.cache                       | ``PUFFER_DAEMON_DATA_CACHE``                       | ``"cache"``                 | The path of the directory to use as a cache folder.                          |
+-----------------------------------------+----------------------------------------------------+-----------------------------+------------------------------------------------------------------------------+
| daemon.data.servers                     | ``PUFFER_DAEMON_DATA_SERVERS``                     | ``"servers"``               | The path of the directory in which to store the servers' data.               |
+-----------------------------------------+----------------------------------------------------+-----------------------------+------------------------------------------------------------------------------+
| daemon.data.backups.folder              | ``PUFFER_DAEMON_DATA_BACKUPS_FOLDER``              | ``"backups"``               | The path of the directory in which to store server backups.                  |
+-----------------------------------------+----------------------------------------------------+-----------------------------+------------------------------------------------------------------------------+
| daemon.data.binaries                    | ``PUFFER_DAEMON_DATA_BINARIES``                    | ``"binaries"``              | The path of the directory in which to store downloaded binary files          |
...
|                                         |                                                    |                             | | If this value is an empty string, the servers folder will be used instead. |
+-----------------------------------------+----------------------------------------------------+-----------------------------+------------------------------------------------------------------------------+
| daemon.data.crashLimit                  | ``PUFFER_DAEMON_DATA_CRASHLIMIT``                  | ``3``                       | The maximum amount of times that a server can crash while still being        |
|                                         |                                                    |                             | restarted.                                                                   |
+-----------------------------------------+----------------------------------------------------+-----------------------------+------------------------------------------------------------------------------+
| daemon.curseforge.key                   | ``PUFFER_DAEMON_CURSEFORGE_KEY``                   | ``""``                      | The CurseForge API key to use for downloading mods.                          |
+-----------------------------------------+----------------------------------------------------+-----------------------------+------------------------------------------------------------------------------+
| daemon.depotDownloader.version          | ``PUFFER_DAEMON_DEPOTDOWNLOADER_VERSION``          | ``"latest"``                | The version tag that should be used when downloading DepotDownloader.        |
+-----------------------------------------+----------------------------------------------------+-----------------------------+------------------------------------------------------------------------------+
| daemon.depotDownloader.disableLancache  | ``PUFFER_DAEMON_DEPOTDOWNLOADER_DISABLELANCACHE``  | ``false``                   | Whether to disable the usage of a LAN cache by DepotDownloader.              |
+-----------------------------------------+----------------------------------------------------+-----------------------------+------------------------------------------------------------------------------+
...
|                                         |                                                    |                             | when registering the remote node.                                            |
+-----------------------------------------+----------------------------------------------------+-----------------------------+------------------------------------------------------------------------------+
| security.forceOpenat                    | ``PUFFER_SECURITY_FORCEOPENAT``                    | ``false``                   | | Override the check for the OpenAt2 syscall and force to not use it.        |
...
|                                         |                                                    |                             | proxy.                                                                       |
+-----------------------------------------+----------------------------------------------------+-----------------------------+------------------------------------------------------------------------------+
| security.disableUnshare                 | ``PUFFER_SECURITY_DISABLEUNSHARE``                 | ``false``                   | Whether to globally disable the usage of unshare.                            |
+-----------------------------------------+----------------------------------------------------+-----------------------------+------------------------------------------------------------------------------+
...
|                                         |                                                    |                             | a docker container.                                                          |
+-----------------------------------------+----------------------------------------------------+-----------------------------+------------------------------------------------------------------------------+
| docker.disallowHost                     | ``PUFFER_DOCKER_DISALLOW_HOST``                    | ``false``                   | Whether to disable any environment not running in docker (e.g. tty).         |
+-----------------------------------------+----------------------------------------------------+-----------------------------+------------------------------------------------------------------------------+
