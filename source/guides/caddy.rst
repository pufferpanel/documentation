...
Caddy supports SSL out of the box with no configuration, so the only thing you will need to do is update the hostname in the configuration below to match your desired hostname.
